...
class _OutcomeScreenState extends State<OutcomeScreen>
  ...
  final OutcomeModel data = demoOutcome;

  String _formatNumber(int number) {
    if (number == 1400000) return "14,00,000";
    if (number == 990000) return "9,90,000";
    if (number == 320000) return "3,20,000";
    if (number == 5200) return "5,200";
                    ...
                    Container(
                      ...
                      child: AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          ...
                          return CustomPaint(
                            painter: RecoveryGraphPainter(progress: progress),
                          );
                        },
                      ),
                    ),
                ...
                child: Container(
                  ...
                  child: IntrinsicHeight(
                    child: Row(
                      ...
                      children: [
                        _buildEconomicsCol("5,200", AppColors.textPrimary,
                            "Projected Reach", "impressions"),
                        const VerticalDivider(
                            color: AppColors.border, width: 1, thickness: 0.5),
                        _buildEconomicsCol("₨ 9,90,000", AppColors.textPrimary,
                            "Revenue Recovered", ""),
                        const VerticalDivider(
                            color: AppColors.border, width: 1, thickness: 0.5),
                        _buildEconomicsCol(
                            "2.8×", AppColors.success, "ROAS", "return"),
                      ],
                    ),
                  ),
                ),
...
class RecoveryGraphPainter extends CustomPainter {
  ...
  RecoveryGraphPainter({required this.progress});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    pathBefore.moveTo(leftPadding, yToPixels(142));
    pathBefore.lineTo(size.width, yToPixels(130));
    ...
    if (progress > 0) {
      ...
      pathAfter.moveTo(centerX, yToPixels(142));

      // Control point for curve
      final endX = size.width;
      final endY = yToPixels(186);
      ...
      if (pathMetricsList.isNotEmpty) {
        ...
        if (currentMetric != null) {
          ...
          final fillPaint = Paint()
            ..color = const Color(0xFFEBF2FE).withValues(alpha: 0.4)
